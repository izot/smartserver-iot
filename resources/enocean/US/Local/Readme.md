...
-   [EnOcean-US-lcl-V6.dtp - Consolidated Device Type Package File](#Complete)
...
-   **BACnet Type Mapping File Name:** ELLSU-lcl-V3.btm (bundled in the package file)
...
-   **BACnet Type Mapping File Name:** EMCSU-lcl-V4.btm (bundled in the package file)
...
-   **File Name:** EMDCU-lcl-V4.dtp
-   **EnOcean Equipment Profile (EEP):** A5-07-03
-   **Device Model Number:** EMDCU-W-EO
-   **BACnet Type Mapping File Name:** EMDCU-lcl-V4.btm (bundled in the package file)
...
-   **File Name:** STM550U-lcl-V5.dtp
-   **EnOcean Equipment Profile (EEP):** D2-14-41 (default)
-   **Device Model Number:** STM550U
-   **BACnet Type Mapping File Name:** STM550U-lcl-V5.btm (bundled in the package file)
...
-   **File Name:** EOSxU-lcl-V3.dtp
-   **EnOcean Equipment Profile (EEP):** A5-07-01
-   **Device Model Number:** EOSCU-W-EO, EOSWU-W-EO, EOSHU
-   **BACnet Type Mapping File Name:** EOSxU-lcl-V3.btm (bundled in the package file)
...
-   **BACnet Type Mapping File Name:** EDRPU-lcl-V2.btm (bundled in the package file)
...
-   **BACnet Type Mapping File Name:** ESRPU-lcl-V2.btm (bundled in the package file)
...
-   **File Name:** EnOcean-US-lcl-V6.dtp
