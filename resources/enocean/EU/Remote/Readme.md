...
-   **File Name:** ELLSA-rem-V1.dtp
-   **EnOcean Equipment Profile (EEP):** A5-06-02
-   **Device Model Number:** ELLSA-W-EO
-   **BACnet Type Mapping File Name:** ELLSA-rem-V1.btm
...
-   **File Name:** EPACA-rem-V1.dtp
-   **EnOcean Equipment Profile (EEP):** D2-15-00
-   **Device Model Number:** EPACA
-   **BACnet Type Mapping File Name:** EPACA-rem-V1.btm
...
-   **BACnet Type Mapping File Name:** EDRPA-rem-V1.btm
