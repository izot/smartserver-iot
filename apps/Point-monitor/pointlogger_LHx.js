...
var monitorSpecs = [
        ...
        nvList: [
            {ptPath: 'device/0/nvoPF', ms:{rate: 60, report: 'any', inFeedback:false, event:false}}, 
            //{ptPath: 'device/0/nvoPF_2', ms:{rate: 30, report: 'any', inFeedback:false, event:false}}, 
            {ptPath: 'device/0/nvoI', ms:{rate: 60, report: 'any', inFeedback:false, event:false}}, 
            {ptPath: 'device/0/nvoU_F', ms:{rate: 60, report: 'any', inFeedback:false, event:false}}, 
            {ptPath: 'device/0/nvoP', ms:{rate: 60, report: 'any', inFeedback:false, event:false}}, 
            {ptPath: 'device/0/nvoEPpos', ms:{rate: 60, report: 'any', inFeedback:false, event:false}}, 
            //{ptPath: 'device/0/nvoI_2', ms:{rate: 30, report: 'any', inFeedback:false, event:false}}, 
            //{ptPath: 'device/0/nvoU_F_2', ms:{rate: 30, report: 'any', inFeedback:false, event:false}}, 
            //{ptPath: 'device/0/nvoP_2', ms:{rate: 30, report: 'any', inFeedback:false, event:false}}, 
            //{ptPath: 'device/0/nvoEPapos', ms:{rate: 30, report: 'any', inFeedback:false, event:false}},
        ]
    }
];
...
function handleDeviceSts (devHandle, stsMsg, monSpecIndex) {
    ...
    if (stsMsg.state === "provisioned") {
        ...
        if (rateOverride == -2 || !setMonitorParams) {
            if (!setMonitorParams)
