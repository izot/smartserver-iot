...
"""setbackMinutes userdefined datapoint type, originally defined in resource
...
class setbackMinutes(izot.resources.base.Scaled):
    """setbackMinutes userdefined datapoint type.  (minutes)."""
