...
"""enable userdefined datapoint type, originally defined in resource file set
apollodev 90:00:01:06:00:00:00:00-4.  """


import izot.resources.enumerations.boolean_t
from P9000010600000000_4.userdefined import userdefined


class enable(izot.resources.enumerations.boolean_t.boolean_t):
    """enable userdefined datapoint type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._override_scope(4)
        self._override_key(28)
        self._original_name = 'UNVTenable'
