...
"""capState userdefined datapoint type, originally defined in resource file
set apollodev 90:00:01:06:00:00:00:00-4.  """


import P9000010600000000_4.enumerations.capState
from P9000010600000000_4.userdefined import userdefined


class capState(P9000010600000000_4.enumerations.capState.capState):
    """capState userdefined datapoint type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._override_scope(4)
        self._override_key(27)
        self._original_name = 'UNVTcapState'
