...
"""fixed2 userdefined datapoint type, originally defined in resource file set
...
class fixed2(izot.resources.base.Scaled):
    """fixed2 userdefined datapoint type.  0.01 unit step."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UNVTfixed2'
