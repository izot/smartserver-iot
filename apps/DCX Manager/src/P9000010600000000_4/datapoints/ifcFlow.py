...
"""ifcFlow userdefined datapoint type, originally defined in resource file
...
class ifcFlow(izot.resources.base.Scaled):
    """ifcFlow userdefined datapoint type.  Aggregate packet flow RX + TX.
    (packets per sec.)."""
    ...
    def __init__(self):
        super().__init__(
            ...
            scaling=(0.01, 0),
            minimum=0,
            maximum=4.29497E+007,
            scope=4,
            key=15
        )
        self._original_name = 'UNVTifcFlow'
