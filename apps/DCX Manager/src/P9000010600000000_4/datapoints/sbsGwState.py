...
"""sbsGwState userdefined datapoint type, originally defined in resource file
...
class sbsGwState(P9000010600000000_4.enumerations.sbs_cntrl.sbs_cntrl):
    """sbsGwState userdefined datapoint type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._override_scope(4)
        self._override_key(23)
        self._original_name = 'UNVTsbsGwState'
