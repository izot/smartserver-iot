...
"""bacnetPosInt userdefined datapoint type, originally defined in resource
...
class bacnetPosInt(izot.resources.base.Scaled):
    """bacnetPosInt userdefined datapoint type.  ."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UNVTbacnetPosInt'
