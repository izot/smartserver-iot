...
"""fixed3 userdefined datapoint type, originally defined in resource file set
...
class fixed3(izot.resources.base.Scaled):
    """fixed3 userdefined datapoint type.  0.005 unit step."""
