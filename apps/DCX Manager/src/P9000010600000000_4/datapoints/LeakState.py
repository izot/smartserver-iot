...
"""LeakState userdefined datapoint type, originally defined in resource file
set apollodev 90:00:01:06:00:00:00:00-4.  """


import P9000010600000000_4.enumerations.LS_state
from P9000010600000000_4.userdefined import userdefined


class LeakState(P9000010600000000_4.enumerations.LS_state.LS_state):
    """LeakState userdefined datapoint type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._override_scope(4)
        self._override_key(21)
        self._original_name = 'UNVT_LeakState'
