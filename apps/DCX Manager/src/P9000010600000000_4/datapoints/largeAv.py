...
"""largeAv userdefined datapoint type, originally defined in resource file
...
class largeAv(izot.resources.base.Float):
    """largeAv userdefined datapoint type.  ."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UNVTlargeAv'
