...
"""eps userdefined datapoint type, originally defined in resource file set
...
class eps(izot.resources.base.Scaled):
    """eps userdefined datapoint type.  eps Events per second.  (eps)."""
