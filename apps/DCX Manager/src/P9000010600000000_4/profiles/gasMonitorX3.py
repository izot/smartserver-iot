...
"""gasMonitorX3 userdefined profile, originally defined in resource file set
...
class gasMonitorX3(izot.resources.base.Profile):
    """gasMonitorX3 userdefined profile.  Gas Sesnosr Monitor.  """
    ...
    def __init__(self):
        ...
        self.datapoints['Alarm1o'] = izot.resources.base.Profile.DatapointMember(
            doc="""Absolute count.  """,
            name='Alarm1o',
            profile=self,
            number=10,
        ...
        self.datapoints['Alarm2o'] = izot.resources.base.Profile.DatapointMember(
            doc="""Absolute count.  """,
            name='Alarm2o',
            profile=self,
            number=11,
        ...
        self._original_name = 'UFPTgasMonitorX3'
