...
"""offSequence userdefined property type, originally defined in resource file
set apollodev 90:00:01:06:00:00:00:00-4."""


import P9000010600000000_4.enumerations.offSequence
from P9000010600000000_4.userdefined import userdefined


class offSequence(P9000010600000000_4.enumerations.offSequence.offSequence):
    """offSequence userdefined property type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._override_scope(4)
        self._override_key(24)
        self._default_bytes = b'\x00'
        self._original_name = 'UCPToffSequence'
        self._property_scope, self._property_key = 4, 24
