...
"""defaultLevel userdefined property type, originally defined in resource
file set apollodev 90:00:01:06:00:00:00:00-4."""


import izot.resources.datapoints.lev_cont
from P9000010600000000_4.userdefined import userdefined


class defaultLevel(izot.resources.datapoints.lev_cont.lev_cont):
    """defaultLevel userdefined property type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._default_bytes = b'\xc8'
        self._original_name = 'UCPTdefaultLevel'
        self._property_scope, self._property_key = 4, 23
