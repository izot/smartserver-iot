...
"""restartMode userdefined property type, originally defined in resource file
set apollodev 90:00:01:06:00:00:00:00-4."""


import P9000010600000000_4.enumerations.eRestart
from P9000010600000000_4.userdefined import userdefined


class restartMode(P9000010600000000_4.enumerations.eRestart.eRestart):
    """restartMode userdefined property type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._override_scope(4)
        self._override_key(16)
        self._default_bytes = b'\x01'
        self._original_name = 'UCPTrestartMode'
        self._property_scope, self._property_key = 4, 16
