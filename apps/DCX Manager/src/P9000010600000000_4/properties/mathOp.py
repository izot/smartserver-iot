...
"""mathOp userdefined property type, originally defined in resource file set
apollodev 90:00:01:06:00:00:00:00-4."""


import P9000010600000000_4.enumerations.MathOp
from P9000010600000000_4.userdefined import userdefined


class mathOp(P9000010600000000_4.enumerations.MathOp.MathOp):
    """mathOp userdefined property type.  ."""
