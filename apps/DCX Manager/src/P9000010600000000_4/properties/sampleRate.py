...
"""sampleRate userdefined property type, originally defined in resource file
...
class sampleRate(izot.resources.base.Scaled):
    """sampleRate userdefined property type.  (seconds)."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UCPTsampleRate'
        self._property_scope, self._property_key = 4, 12
