...
"""rebootTm userdefined property type, originally defined in resource file
set apollodev 90:00:01:06:00:00:00:00-4."""


import P9000010600000000_4.datapoints.time
from P9000010600000000_4.userdefined import userdefined


class rebootTm(P9000010600000000_4.datapoints.time.time):
    """rebootTm userdefined property type.  ."""

    def __init__(self):
        super().__init__(
        )
        self._default_bytes = b'\x00\x00'
        self._original_name = 'UCPTrebootTm'
        self._property_scope, self._property_key = 4, 15
