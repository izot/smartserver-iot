...
"""stackOffTime userdefined property type, originally defined in resource
...
class stackOffTime(izot.resources.base.Scaled):
    """stackOffTime userdefined property type.  (s)."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UCPTstackOffTime'
        self._property_scope, self._property_key = 4, 17
