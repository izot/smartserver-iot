...
"""sbsTmo userdefined property type, originally defined in resource file set
...
class sbsTmo(izot.resources.base.Scaled):
    """sbsTmo userdefined property type.  Timeout for sentinel monitoring.
    (minutes)."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UCPTsbsTmo'
        self._property_scope, self._property_key = 4, 20
