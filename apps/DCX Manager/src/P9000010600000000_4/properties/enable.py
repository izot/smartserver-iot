...
"""enable userdefined property type, originally defined in resource file set
...
class enable(izot.resources.base.Scaled):
    """enable userdefined property type.  ."""
    ...
    def __init__(self):
        ...
        self._original_name = 'UCPTenable'
        self._property_scope, self._property_key = 4, 13
