...
"""powerLine userdefined property type, originally defined in resource file
...
class powerLine(izot.resources.base.Scaled):
    """powerLine userdefined property type.  Set to 1 to throttle channel
    updates for PL channel."""
