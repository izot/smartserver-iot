...
"""delayWindow userdefined property type, originally defined in resource file
...
class delayWindow(izot.resources.base.Scaled):
    """delayWindow userdefined property type.  Random window to and to
    delay.  (ms)."""
