...
"""activeCount userdefined property type, originally defined in resource file
...
class activeCount(izot.resources.base.Scaled):
    """activeCount userdefined property type.  ."""
