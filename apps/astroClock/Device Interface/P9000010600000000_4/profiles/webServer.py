...
"""webServer userdefined profile, originally defined in resource file set
...
class webServer(izot.resources.base.Profile):
    """webServer userdefined profile.  """
    ...
    def __init__(self):
        ...
        self._original_name = 'UFPTwebServer'
