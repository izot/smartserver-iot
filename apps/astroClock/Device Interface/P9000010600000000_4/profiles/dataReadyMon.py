...
"""dataReadyMon userdefined profile, originally defined in resource file set
...
class dataReadyMon(izot.resources.base.Profile):
    """dataReadyMon userdefined profile.  """
