...
"""fixed1 userdefined datapoint type, originally defined in resource file set
...
class fixed1(izot.resources.base.Scaled):
    """fixed1 userdefined datapoint type.  0.1 unit step."""
